...
void DramcDUTTopSet(void *ctx)
{
    ...
    raw_set_u32(ctx, 0xb0, type != 3U);
    raw_set_u32(ctx, 0x44, 0x10U);

    d[0xae] = 0; d[0xad] = 0;
    d[0xb3] = (U8)(MEM_TYPE >> 0);
    d[0xb4] = (U8)(MEM_TYPE >> 8);
    d[0xb5] = (U8)(MEM_TYPE >> 16);
    d[0xb6] = (U8)(MEM_TYPE >> 24);
    ...
    d[0xaa] = 1; d[0xa6] = 1; d[0xa3] = 1; d[0xa2] = 1;
    d[0xa0] = 0; d[0x9f] = 0; d[0x9e] = 0; d[0x9c] = 0;
    d[0x98] = 2; d[0x96] = 0; d[0x97] = 4;
    d[0x94] = 0; d[0x93] = 0; d[0x92] = 0; d[0x91] = 0; d[0x90] = 0;
    d[0x8e] = 0; d[0x8d] = 0; d[0x8c] = 0; d[0x8b] = 0;
    d[0x89] = 0; d[0x88] = 0; d[0x86] = 0; d[0x85] = 0; d[0x84] = 0; d[0x83] = 0;
    d[0x9d] = 1; d[0x9b] = 1; d[0x9a] = 1; d[0x99] = 1;
    d[0x95] = 8; d[0x8f] = 1; d[0x8a] = 1; d[0x87] = 1; d[0x82] = 3;

    if (is_ddr4_family(ctx)) { d[0x81] = 1; d[0x80] = 1; }
    if (is_ddr3_family(ctx)) { d[0x81] = 0; d[0x80] = 0; }
