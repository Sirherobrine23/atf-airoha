/* AN7583 DDR4 init reconstructed from DDR4_dram_init.o. */
...
void DDR4_SWZQ(void *ctx, U32 rank) { DramcZQCalibration(ctx, rank); }
...
void PC4_dram_init_single_rank(void *ctx, const U8 cfg[9], U32 rank)
{
    ...
    U16 mr2 = ((cfg[0]<<3)&0x38U) | 0xc0U;
    U16 mr3 = (raw_u32(ctx,0x10) != 0 ? 1U : 2U) << 9;
    U16 mr4 = 0x800U, mr5=0x400U;
    U16 mr6 = ((cfg[8]<<10)&0x1c00U) |
              (raw_u32(ctx,0x20)==1U ? 0x20U : 0x8U);
    U16 mr6_set = mr6 | 0x80U;
    ...
    DramcModeRegWriteByRank(ctx,rank,6,mr6_set);
    udelay(1);
    DramcModeRegWriteByRank(ctx,rank,6,mr6_set);
    udelay(1);
    DramcModeRegWriteByRank(ctx,rank,6,mr6);
    udelay(1);
