...
void RODTSettings(void *ctx)
{
    ...
    vPhyByteWriteFldAlign(ctx, 0x51200f30U, inv, 0x00040116U, 0);
    vPhyByteWriteFldAlign(ctx, 0x59200fb0U, inv, 0x00040116U, 0);
...
void EnableDramcPhyDCMNonShuffle(void *ctx, U32 enable)
{
    ...
    if (enable) {
        ...
        vPhyByteIO32WriteMsk_All(ctx, 0x010007c8U, 0x000001c0U, 0x000001c0U);
        ...
        vPhyByteIO32WriteMsk_All(ctx, 0x010007c8U, 0, 0x000001ffU);
        vPhyByteIO32WriteMsk_All(ctx, 0x000001b0U, 0, 0x00620000U);
        vPhyByteIO32WriteMsk_All(ctx, 0x000001a0U, 0, 0x00180000U);
...
void vReplaceDVInit(void *ctx)
{
    ...
    vIO32WriteMsk(ctx, 0x00000150U, 0, 0x00007800U);
